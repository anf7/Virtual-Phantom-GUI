...
global AX1_LINE_H AX1_LINE_V AX2_LINE_V AX3_LINE_H AX3_LINE_V
global IMG1 IMG2 IMG3
global AX1_TEXT AX2_TEXT AX3_TEXT

rpos = getPosition(AX1_LINE_H);
cpos = getPosition(AX3_LINE_V);
spos = getPosition(AX3_LINE_H);
setPosition(AX1_LINE_V,[cpos(1,1),DICOM.RR(1);cpos(2,1),DICOM.RR(2)])
setPosition(AX2_LINE_V,[spos(1,2),DICOM.RR(1);spos(2,2),DICOM.RR(2)])
