...
global AX1_LINE_H AX1_LINE_V AX2_LINE_H AX2_LINE_V AX3_LINE_V
...
setPosition(AX2_LINE_H,[DICOM.RS(1),rpos(1,2);DICOM.RS(2),rpos(2,2)])
setPosition(AX3_LINE_V,[cpos(1,1),DICOM.RS(1);cpos(2,1),DICOM.RS(2)])
